...
export default function Home() {
  return (
    <section className="py-24 flex flex-col items-center gap-9">
      <div className="flex flex-col items-center gap-4 font-inter text-xl text-center">
        ...
        <h1 className="font-poppins text-[40px]/[48px] font-semibold @laptop:text-7xl/[86.4px]">
          ...
          <span className="mx-2 @laptop:mx-1">
            <Image className="inline w-[72px] @laptop:hidden" src={Collectibles} alt="" />
          </span>

          um Universo

          <span className="mx-1 @laptop:mx-2">
            <Image className="hidden @laptop:inline" src={Toggle} alt="" />
          </span>

          Digital

          <span className="mx-2 @laptop:mx-1">
            <Image className="inline w-[102px] @laptop:hidden" src={Toggle} alt="" />
          </span>

          de

          <span className="mx-1 @laptop:mx-2">
            <Image className="hidden @laptop:inline" src={Collectibles} alt="" />
          </span>
